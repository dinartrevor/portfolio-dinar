...
export default function Edit({ experience }) {
    const [preview, setPreview] = useState(experience.image ? `/storage/${experience.image}` : null);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.freelance-experiences.update', experience.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                    Edit Freelance Experience: {experience.project_name}
                </h2>
            }
        >
            <Head title={`Edit Freelance - ${experience.project_name}`} />
